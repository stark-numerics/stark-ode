...
def test_crouzeix_dirk3_default_call_path_is_scheme_owned_generic_call() -> None:
    ...
    assert scheme.call_monitorable.__func__ is SchemeCrouzeixDIRK3.call_inline
...
def test_crouzeix_dirk3_specialist_path_is_scheme_owned_generated_call() -> None:
    ...
    assert scheme.call_monitorable.__self__ is scheme
    assert scheme.call_monitorable.__func__ is SchemeCrouzeixDIRK3.call_specialized
    assert scheme.redirect_call == scheme.call_monitorable
