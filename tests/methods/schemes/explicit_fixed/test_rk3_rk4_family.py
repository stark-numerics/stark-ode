...
def test_rk3_rk4_linear_fixed_path_is_selected_inside_scheme(scheme_cls) -> None:
    scheme = scheme_cls(
        dummy_exponential_growth_rhs,
        DummyScalarAllocator(),
...
def test_rk3_rk4_inline_and_linear_fixed_paths_match_for_one_step(scheme_cls) -> None:
