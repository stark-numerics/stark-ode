# Algebraist backend paths

Last reviewed: 2026-06-17.

This is contributor documentation. It describes intended internal wiring and is expected to be fragile. Re-check the source before making engine or Algebraist changes.
