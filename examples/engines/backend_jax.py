"""Use the JAX engine with a return-style dynamics.

JAX arrays are immutable, so this example uses DynamicsStyle.accepts_instant_returns rather
than an in-place dynamics. The solver control flow remains ordinary STARK
...
try:
    ...
    if __name__ == "__main__":
        ...
        print("JAX return-style dynamics")
