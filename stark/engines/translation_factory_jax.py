...
class TranslationFactoryJax:
    ...
    def __add__(self, other: TranslationFactoryJax) -> TranslationFactoryJax:
    ...
    def __rmul__(self, scalar: float) -> TranslationFactoryJax:
        result = self.allocator.allocate_translation()
        for field, carrier in zip(self.frame.fields, self.carriers, strict=True):
            field.translation_path.assign(
                result,
    ...
    def __mul__(self, scalar: float) -> TranslationFactoryJax:
