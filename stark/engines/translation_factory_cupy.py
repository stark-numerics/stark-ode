...
class TranslationFactoryCupy:
    ...
    allocator: AllocatorLike[Any, TranslationFactoryCupy] = field(repr=False)
    ...
    def __add__(self, other: TranslationFactoryCupy) -> TranslationFactoryCupy:
    ...
    def __rmul__(self, scalar: float) -> TranslationFactoryCupy:
        result = self.allocator.allocate_translation()
        for field, carrier in zip(self.frame.fields, self.carriers, strict=True):
    ...
    def __mul__(self, scalar: float) -> TranslationFactoryCupy:
...
__all__ = ["TranslationFactoryCupy"]
