...
@dataclass
class TranslationFactoryNative:
    ...
    def __add__(self, other: TranslationFactoryNative) -> TranslationFactoryNative:
    ...
    def __rmul__(self, scalar: float) -> TranslationFactoryNative:
        result = self.allocator.allocate_translation()
        for field, carrier in zip(self.frame.fields, self.carriers, strict=True):
    ...
    def __mul__(self, scalar: float) -> TranslationFactoryNative:
...
__all__ = ["TranslationFactoryNative"]
