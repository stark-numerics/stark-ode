...
class TranslationFactoryNumpy:
    ...
    allocator: AllocatorLike[Any, TranslationFactoryNumpy] = field(repr=False)
    ...
    def __add__(self, other: TranslationFactoryNumpy) -> TranslationFactoryNumpy:
    ...
    def __rmul__(self, scalar: float) -> TranslationFactoryNumpy:
        result = self.allocator.allocate_translation()
        for field, carrier in zip(self.frame.fields, self.carriers, strict=True):
    ...
    def __mul__(self, scalar: float) -> TranslationFactoryNumpy:
...
__all__ = ["TranslationFactoryNumpy"]
