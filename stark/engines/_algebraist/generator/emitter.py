...
class AlgebraistGeneratorEmitter:
    ...
    def linear_fixed(self, stencil: AlgebraistStencil) -> str:
        ...
        *,
        ...
        if kind == "general":
            ...
            if coefficients is None:
                raise ValueError("linear_fixed emission requires coefficients.")
            hoist_lines = [
        ...
        *,
        ...
        if kind == "general":
            ...
            if fixed_coefficients is None:
                raise ValueError("fixed coefficients are required for linear_fixed emission.")
