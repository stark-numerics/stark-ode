...
class GivensRotations:
    ...
    def __init__(self, restart: int) -> None:
        ...
        if not self.__class__._compiled:
            ...
            compile_if_you_can(_givens, (1.0, 0.5))
            compile_if_you_can(_apply_previous_rotations, (hessenberg, self.cosines, self.sines, 0))
            compile_if_you_can(_apply_new_rotation, (hessenberg, residual_vector, self.cosines, self.sines, 0))
    ...
    def apply_previous(self, hessenberg, column: int) -> None:
        ...
        _apply_previous_rotations(hessenberg, self.cosines, self.sines, column)
    ...
    def apply_new(self, hessenberg, residual_vector, column: int) -> float:
        ...
        return _apply_new_rotation(hessenberg, residual_vector, self.cosines, self.sines, column)
...
class HessenbergLeastSquares:
    ...
    __slots__ = ("restart", "hessenberg", "residual_vector", "coefficients")
    _compiled = False
    ...
    def __init__(self, restart: int) -> None:
        ...
        if not self.__class__._compiled:
            compile_if_you_can(_back_substitute, (self.hessenberg, self.residual_vector, self.coefficients, 1))
            self.__class__._compiled = True
