...
class SchemeDormandPrince:
    ...
    def call_inline(
        ...
        while True:
            ...
            derivative(stage_interval(interval, dt, dt * RKDP_C[1]), stage, k2)
            ...
            stage_delta(state, stage)
            derivative(stage_interval(interval, dt, dt * RKDP_C[2]), stage, k3)
            ...
            stage_delta(state, stage)
            derivative(stage_interval(interval, dt, dt * RKDP_C[3]), stage, k4)
            ...
            stage_delta(state, stage)
            derivative(stage_interval(interval, dt, dt * RKDP_C[4]), stage, k5)
            ...
            stage_delta(state, stage)
            derivative(stage_interval(interval, dt, dt * RKDP_C[5]), stage, k6)
