    ...
    def advance_body(self, interval: IntervalLike, state: State) -> None:
        ...
        while True:
            try:
                ...
                rejection_count += 1
                dt = controller.rejected_step(dt, 1.0, remaining, "KC54b")
                continue
            ...
            if error_ratio <= 1.0:
                break
            rejection_count += 1
            dt = controller.rejected_step(dt, error_ratio, remaining, "KC54b")
...
__all__ = ["ARK548L2SAB_TABLEAU", "SchemeKennedyCarpenter54b"]
