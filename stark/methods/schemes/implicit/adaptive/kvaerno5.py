...
class SchemeKvaerno5:
    ...
    def prepare_specialized_kernels(self, linear_fixed: SchemeLinearFixedLike) -> None:
        self.known2_call = linear_fixed(SchemeStencil((1.0,), scale=KVAERNO5_GAMMA))
        ...
        self.known6_call = linear_fixed(SchemeStencil(_KNOWN6_WEIGHTS))
        self.known7_call = linear_fixed(SchemeStencil(_KNOWN7_WEIGHTS))
