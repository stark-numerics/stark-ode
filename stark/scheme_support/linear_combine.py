...
class Combiner:
    ...
    hot scheme, resolver, and inverter paths.
    """
    ...
    def __init__(self, linear_combine: LinearCombine, allocate_translation: Callable[[], Translation]) -> None:
        ...
        self.combine5 = (
            ...
            else Combine5Worker(self.combine2, self.combine3, allocate_translation)
        )
        self.combine6 = (
            linear_combine[5]
            if len(linear_combine) >= 6
            else Combine6Worker(self.combine2, self.combine3, allocate_translation)
        )
        self.combine7 = (
            linear_combine[6]
...
def complete_linear_combine(
    ...
    return Combiner(linear_combine, allocate_translation).as_tuple()
