...
class ResolventNewton:
    ...
    Newton iteration repeatedly linearizes the stage residual, solves the
    correction equation with the configured inverter, and adds that correction
    to the current stage increment.
