...
class AlgebraistRuntimeDeltaSpecialist(Generic[TranslationType]):
    """Runtime provider of fixed-coefficient translation-delta kernels."""
    ...
    def provide(self, request: AlgebraistDeltaStencil) -> AlgebraistDeltaKernel[TranslationType]:
        return self._support.provide_delta(request)


__all__ = ["AlgebraistRuntimeDeltaSpecialist"]
