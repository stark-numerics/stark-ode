...
from stark.core.contracts.problem.translation import Translation, TranslationTypeContravariant


class TranslationOperator(Protocol[TranslationTypeContravariant]):
    """
...
TranslationOperatorType = TypeVar("TranslationOperatorType", bound=TranslationOperator)


__all__ = ["TranslationOperator", "TranslationOperatorType"]
